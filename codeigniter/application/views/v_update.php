...
<body>
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action="<?php echo base_url(); ?>index.php/karyawan/store_data" method="POST">
				...
				<div class="wrap-input100 validate-input">
					...
					<input class="input100" type="text" name="id" value="<?php echo $key->id_karyawan ?>" READONLY>
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input" data-validate="Name is required">
					<span class="label-input100">Nama</span>
					<input class="input100" type="text" name="nama" value="<?php echo $key->nama ?>">
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input" data-validate="Telp is required">
					<span class="label-input100">Telphone</span>
					<input class="input100" type="text" name="telp" value="<?php echo $key->telp ?>">
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input" data-validate = "Address is required">
					<span class="label-input100">Alamat</span>
					<textarea class="input100" name="alamat"><?php echo $key->alamat ?></textarea>
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input" data-validate="Gaji is required">
					<span class="label-input100">Gaji</span>
					<input class="input100" type="number" name="gaji" value="<?php echo $key->gaji ?>">
					<span class="focus-input100"></span>
				</div>
